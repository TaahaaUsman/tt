...
import { ArrowLeft, ArrowRight, Eye } from "../../assets/Svgs/Svgs";
...
const UserAccountTable = ({ data }) => {
  ...
  // Compact pagination list (e.g. 1 ... 4 5 6 ... 10)
  ...
  return (
    <>
      <div className="custom-card px-15 py-16">
        <div className="table-responsive max-height-table px-10">
