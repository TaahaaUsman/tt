                    ...
                    >
                      <td>
                        <div className="d-flex justify-content-center flex-column">
                          {row?.name} <span className="aa-text-xs fw-normal" style={{ color: "#475467" }}>{row?.id}</span>
                        </div>
                      </td>
                      <td>{row?.company}</td>
...
export default OpenEncounterTable;
